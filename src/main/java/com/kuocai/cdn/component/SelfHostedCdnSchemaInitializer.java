...
public class SelfHostedCdnSchemaInitializer {
    ...
    public void init() {
        execute("CREATE TABLE IF NOT EXISTS self_hosted_node (" +
                ...
                "cache_storage_key VARCHAR(128) NULL,cache_storage_writer TINYINT NOT NULL DEFAULT 0," +
                "cache_local_fallback TINYINT NOT NULL DEFAULT 0," +
                ...
                "KEY idx_self_hosted_node_cache_storage (cache_storage_key,enabled)" +
        ...
        execute("CREATE TABLE IF NOT EXISTS self_hosted_node_event (" +
                ...
                ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
        execute("CREATE TABLE IF NOT EXISTS self_hosted_statistics_batch (" +
                "id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,node_id BIGINT NOT NULL,batch_id VARCHAR(64) NOT NULL," +
                "create_time DATETIME DEFAULT CURRENT_TIMESTAMP," +
                "UNIQUE KEY uk_self_hosted_statistics_batch (node_id,batch_id)," +
                "KEY idx_self_hosted_statistics_batch_time (create_time)" +
                ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
        execute("CREATE TABLE IF NOT EXISTS self_hosted_domain_metric (" +
                "id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,node_id BIGINT NOT NULL,domain_name VARCHAR(255) NOT NULL," +
                "bucket_start DATETIME NOT NULL,edge_bytes BIGINT NOT NULL DEFAULT 0,origin_bytes BIGINT NOT NULL DEFAULT 0," +
                "hit_bytes BIGINT NOT NULL DEFAULT 0,peak_bandwidth_bps BIGINT NOT NULL DEFAULT 0," +
                "peak_origin_bandwidth_bps BIGINT NOT NULL DEFAULT 0,request_count BIGINT NOT NULL DEFAULT 0," +
                "hit_count BIGINT NOT NULL DEFAULT 0,origin_request_count BIGINT NOT NULL DEFAULT 0," +
                "origin_failure_count BIGINT NOT NULL DEFAULT 0,status_2xx BIGINT NOT NULL DEFAULT 0," +
                "status_3xx BIGINT NOT NULL DEFAULT 0,status_4xx BIGINT NOT NULL DEFAULT 0,status_5xx BIGINT NOT NULL DEFAULT 0," +
                "origin_status_2xx BIGINT NOT NULL DEFAULT 0,origin_status_3xx BIGINT NOT NULL DEFAULT 0," +
                "origin_status_4xx BIGINT NOT NULL DEFAULT 0,origin_status_5xx BIGINT NOT NULL DEFAULT 0," +
                "update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP," +
                "UNIQUE KEY uk_self_hosted_domain_metric (node_id,domain_name,bucket_start)," +
                "KEY idx_self_hosted_domain_metric_query (domain_name,bucket_start)," +
                "KEY idx_self_hosted_domain_metric_time (bucket_start)" +
                ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
        execute("CREATE TABLE IF NOT EXISTS self_hosted_node_group (" +
                ...
                "shared_cache_enabled TINYINT NOT NULL DEFAULT 0," +
        ...
        execute("CREATE TABLE IF NOT EXISTS self_hosted_port_forward (" +
                ...
                "proxy_protocol_enabled TINYINT NOT NULL DEFAULT 0," +
        ...
        addColumnIfAbsent("self_hosted_node_group", "shared_cache_enabled",
                "ALTER TABLE self_hosted_node_group ADD COLUMN shared_cache_enabled TINYINT NOT NULL DEFAULT 0 AFTER dns_record_ids");
        ...
        addColumnIfAbsent("self_hosted_port_forward", "proxy_protocol_enabled",
                "ALTER TABLE self_hosted_port_forward ADD COLUMN proxy_protocol_enabled " +
                        "TINYINT NOT NULL DEFAULT 0 AFTER origin_port");
        ...
        addColumnIfAbsent("self_hosted_node", "cache_storage_key",
                "ALTER TABLE self_hosted_node ADD COLUMN cache_storage_key VARCHAR(128) NULL AFTER cache_disk_mount");
        addColumnIfAbsent("self_hosted_node", "cache_storage_writer",
                "ALTER TABLE self_hosted_node ADD COLUMN cache_storage_writer TINYINT NOT NULL DEFAULT 0 AFTER cache_storage_key");
        addColumnIfAbsent("self_hosted_node", "cache_local_fallback",
                "ALTER TABLE self_hosted_node ADD COLUMN cache_local_fallback TINYINT NOT NULL DEFAULT 0 AFTER cache_storage_writer");
        addIndexIfAbsent("self_hosted_node", "idx_self_hosted_node_cache_storage",
                "ALTER TABLE self_hosted_node ADD INDEX idx_self_hosted_node_cache_storage (cache_storage_key,enabled)");
        addIndexIfAbsent("self_hosted_node", "idx_self_hosted_node_cache_writer",
                "ALTER TABLE self_hosted_node ADD INDEX idx_self_hosted_node_cache_writer " +
                        "(cache_storage_key,cache_storage_writer,enabled,status,last_heartbeat)");
        addColumnIfAbsent("self_hosted_node", "cache_max_size_gb",
                "ALTER TABLE self_hosted_node ADD COLUMN cache_max_size_gb INT NOT NULL DEFAULT 50 AFTER cache_local_fallback");
