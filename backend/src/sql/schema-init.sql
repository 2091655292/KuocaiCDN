...
CREATE TABLE IF NOT EXISTS `dnsmgr_account` (
...
CREATE TABLE IF NOT EXISTS `dnsmgr_domain` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `dnsmgr_user` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `dnsmgr_permission` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `dnsmgr_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dnsmgr_cdn_account` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `type` varchar(20) NOT NULL,
  `name` varchar(255) NOT NULL,
  `config` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `dnsmgr_cdn_domain` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `aid` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dnsmgr_cdn_cache_rule` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `did` int(11) unsigned NOT NULL,
